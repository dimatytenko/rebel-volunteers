...
import { HeroComponentProps } from '../../types/sections';
      ...
      <Container point={POINTS.m}>
        <Wrapper>
          ...
          <HeroContent>
            ...
            <DesktopWrapper>
              <RightBlock>
                <ImageWithPreview src={data?.photos[3].image} width={175} height={235} alt="our photo" loading="lazy" />
            ...
            <MobileWrapper>
              ...
              <MobileBottomWrapper>
                ...
                <ImageWithPreview src={data?.photos[0].image} width={100} height={128} alt="our photo" loading="lazy" />
                <ImageWithPreview src={data?.photos[3].image} width={114} height={154} alt="our photo" loading="lazy" />
              </MobileBottomWrapper>
            </MobileWrapper>
          </HeroContent>
          <Donate />
