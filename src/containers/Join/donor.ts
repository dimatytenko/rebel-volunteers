export const donor = {
  text_uk:
    'Здавайте кров, бо це рятує життя! Щодня ми з вами бачимо ранкові та вечірні повідомлення про те, що станції переливання крові приймають донорів, тож вирішили нагадати, що не слід нехтувати важливими правилами перед здачею.',
  text_en:
  ...
  list: [
    ...
    {
      id: '2',
      title_uk: 'Дотримання дієти',
      description_en:
        'Before donating blood, it is important to adhere to a diet: avoid alcohol and medications, refrain from consuming fatty, spicy, smoked, overly salty, or sweet foods.',
      title_en: 'Diet adherence',
      description_uk:
